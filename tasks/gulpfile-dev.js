module.exports = function(gulp, plugins) {
    ...
    gulp.task('dev_sass', function() {
        ...
        return gulp.src('src/widget/sass/**/*.scss')
            ...
            .pipe(plugins.sourcemaps.write({includeContent: false, sourceRoot: '../sass/'}))
            .pipe(gulp.dest('src/widget/css'))
            .pipe(bs1.reload({stream:true}))
    })

    gulp.task('default', ['dev_conn'], function(){
        gulp.watch('src/widget/sass/**', ['dev_sass'])
        gulp.watch('src/widget/image/**', bs1.reload)
        gulp.watch('src/widget/script/**', bs1.reload)
        gulp.watch('src/widget/html/*.html', bs1.reload)
        gulp.watch('src/widget/html/**', bs1.reload)
        gulp.watch('src/widget/html/**/*.html', bs1.reload)
        gulp.watch('src/widget/index.html', bs1.reload)
    })
